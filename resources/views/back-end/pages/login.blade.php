...
<main>
   ...
   <section class="section login-wrapper register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
      <div class="container">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
               ...
               <div class="card mb-3">
                  ...
                  <span class="d-none d-lg-block">Umeza Construction</span>
                        ...
                        <h5 class="card-title text-center pb-0 fs-5 mb-3">Login to Your Account</h5>
                     </div>
